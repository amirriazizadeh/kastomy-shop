    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(db_index=True, max_length=15, unique=True, validators=[django.core.validators.RegexValidator(message="شماره تلفن باید با فرمت '09123456789' وارد شود.", regex='^09\\d{9}$')], verbose_name='شماره تلفن')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='آدرس ایمیل')),
                ('role', models.CharField(choices=[('CUSTOMER', 'مشتری'), ('SELLER', 'فروشگاه'), ('ADMIN', 'مدیر')], default='CUSTOMER', max_length=10, verbose_name='نقش کاربر')),
